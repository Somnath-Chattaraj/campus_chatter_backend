                ...
                try {
                    ...
                    wss.clients.forEach((client) => {
                        ...
                        if (client.readyState === ws_1.default.OPEN &&
                            (rooms === null || rooms === void 0 ? void 0 : rooms.has(data.roomId))) {
                            client.send(JSON.stringify({
                                type: "newMessage",
                    ...
                    chatRoom.users.forEach((user) => {
                        const isUserConnected = [...wss.clients].some((client) => {
                            var _a;
                            return ((_a = clientRoomMap.get(client)) === null || _a === void 0 ? void 0 : _a.has(data.roomId)) &&
